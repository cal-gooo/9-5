...
export default function Wallet() {
  ...
  if (activeWallet?.status === NDKWalletStatus.READY) {
    return (
      <div className="flex flex-col items-center bg-sky-800">
        <p className="mt-40 text-white">
          <span className="font-bold text-lime-500 text-5xl flex flex-col items-center">
